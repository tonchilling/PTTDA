...
{
    public class M_StationBAL : BaseBL
    {
        bool isCan = false;
        M_StationDAO dao = null;

        public M_StationBAL()
        {
            dao = new M_StationDAO();
        }
        ...
        public override bool Add(object dto)
        {
            ...
            {
                Log((dto as M_StationDTO).Page, "Error", ex.ToString());
            }
            return isCan;
        }
        ...
        public  List<M_StationDTO> FindByObjList(object dto) 
        {
