...
{
    public class M_SectionBAL : BaseBL
    {
        bool isCan = false;
        M_SectionDAO dao = null;

        public M_SectionBAL()
        {
            dao = new M_SectionDAO();
        }
        ...
        public override bool Add(object dto)
        {
            ...
            {
                Log((dto as M_SectionDTO).Page, "Error", ex.ToString());
            }
            return isCan;
        }
        ...
        public  List<M_SectionDTO> FindByObjList(object dto) 
        {
        ...
        public M_SectionDTO FinByRouteCodeName(object dto)
        {


            // return null;
            return dao.FindByRouteCode(dto);
        }
