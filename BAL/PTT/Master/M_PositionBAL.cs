...
{
    public class M_PositionBAL : BaseBL
    {
        bool isCan = false;
        M_PositionDAO dao = null;

        public M_PositionBAL()
        {
            dao = new M_PositionDAO();
        }
        ...
        public override bool Add(object dto)
        {
            ...
            {
                Log((dto as M_PositionDTO).Page, "Error", ex.ToString());
            }
            return isCan;
        }
        ...
        public List<M_PositionDTO> FindByObjList(object dto) 
        {
