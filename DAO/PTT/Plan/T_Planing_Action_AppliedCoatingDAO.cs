...
namespace DAO.PTT.Plan
{
    public class T_Planing_Action_AppliedCoatingDAO : PTTDB
    {
        ...
        public List<T_Planing_File> FindAllFiles(object data)
        {
            ...
            string procName = "sp_T_Planing_Action_AppliedCoating_FindAllFiles";
        ...
        public List<T_Planing_Action_AppliedCoating_InformationDTO> FindAllInformations(object data)
        {
            List<SqlParameter> parameterList = new List<SqlParameter>();
            List<T_Planing_Action_AppliedCoating_InformationDTO> list = new List<T_Planing_Action_AppliedCoating_InformationDTO>();
            dataTable = null;

            string procName = "sp_T_Planing_Action_AppliedCoating_FindAllInformations";
            SqlConnection conn = null;
            try
            {
                if (data != null)
                {
                    ...
                    using (SqlDataReader reader = command.ExecuteReader())
                    {
                        list = ConvertX.GetListFromDataReader<T_Planing_Action_AppliedCoating_InformationDTO>(reader).ToList();
                    }
                }
