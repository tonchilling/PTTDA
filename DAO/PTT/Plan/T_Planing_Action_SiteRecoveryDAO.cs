...
namespace DAO.PTT.Plan
{
    public class T_Planing_Action_SiteRecoveryDAO : PTTDB
    {
        ...
        public List<T_Planing_File> FindAllFiles(object data)
        {
            ...
            string procName = "sp_T_Planing_Action_SiteRecovery_FindAllFiles";
        ...
        public List<T_Planing_ApprovalHistoryDTO> FindAllApprovalHistory(object data)
        {
            List<SqlParameter> parameterList = new List<SqlParameter>();
            List<T_Planing_ApprovalHistoryDTO> list = new List<T_Planing_ApprovalHistoryDTO>();
            dataTable = null;

            string procName = "sp_T_Planing_Action_SiteRecovery_FindAllApprovalHistory";
            SqlConnection conn = null;
            try
            {
                if (data != null)
                {
                    ...
                    using (SqlDataReader reader = command.ExecuteReader())
                    {
                        list = ConvertX.GetListFromDataReader<T_Planing_ApprovalHistoryDTO>(reader).ToList();
                    }
                }
