...
namespace DAO.PTT.Plan
{
    public class T_Planing_Action_SitePreparationDAO : PTTDB
    {
        ...
        public List<T_Planing_File> FindAllFiles(object data)
        {
            ...
            string procName = "sp_T_Planing_Action_SitePreparation_FindAllFiles";
        ...
        public List<M_UndergroundDTO> FindAllUndergrounds(object data)
        {
            List<SqlParameter> parameterList = new List<SqlParameter>();
            List<M_UndergroundDTO> list = new List<M_UndergroundDTO>();
            dataTable = null;

            string procName = "sp_T_Planing_Action_SitePreparation_FindAllUndergrounds";
            SqlConnection conn = null;
            try
            {
                if (data != null)
                {
                    ...
                    using (SqlDataReader reader = command.ExecuteReader())
                    {
                        list = ConvertX.GetListFromDataReader<M_UndergroundDTO>(reader).ToList();
                    }
                }
