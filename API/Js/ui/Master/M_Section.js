...
function SetControl(item) {
    ...
    $(".txtSectionCode").val(item.SectionCode);
...
function Search() {
    ...
    formData.append("SectionCode", $(".txtSectionCodeSearch").val());
    formData.append("Name", $(".txtSectionNameSearch").val());
    ...
    $.ajax({
        ...
        success: function (result) {
            ...
            $.each(obj, function (key, item) {
                ...
                html += '<tr class="TRow" data="' + item.SectionID + '">';
            ...
            buttons: {
                tryAgain: {
                    ...
                    action: function () {
                        ...
                        formData.append("SectionID", $item.attr('data'));
