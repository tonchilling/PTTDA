...
function SetControl(item) {
    ...
    $(".txtStationCode").val(item.StationCode);
...
function Search() {
    ...
    formData.append("StationCode", $(".txtStationCodeSearch").val());
    formData.append("Name", $(".txtStationNameSearch").val());
    ...
    $.ajax({
        ...
        success: function (result) {
            ...
            $.each(obj, function (key, item) {
                ...
                html += '<tr class="TRow" data="' + item.StationID + '">';
            ...
            buttons: {
                tryAgain: {
                    ...
                    action: function () {
                        ...
                        formData.append("StationID", $item.attr('data'));
