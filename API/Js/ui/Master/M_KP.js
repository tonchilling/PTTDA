...
function Search() {
    ...
    formData.append("KPCode", $(".txtKPCodeSearch").val());
    formData.append("Name", $(".txtKPNameSearch").val());
    ...
    $.ajax({
        ...
        success: function (result) {
            ...
            $.each(obj, function (key, item) {
                ...
                html += '<tr class="TRow" data="' + item.KPID + '">';
            ...
            buttons: {
                tryAgain: {
                    ...
                    action: function () {
                        ...
                        formData.append("KPID", $item.attr('data'));
