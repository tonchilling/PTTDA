...
function SetControl(item) {
    ...
    $(".txtCustomerTypeCode").val(item.CustomerTypeCode);
...
function Search() {
    ...
    formData.append("CustomerTypeCode", $(".txtCustomerTypeCodeSearch").val());
    formData.append("Name", $(".txtCustomerTypeNameSearch").val());
    ...
    $.ajax({
        ...
        success: function (result) {
            ...
            $.each(obj, function (key, item) {
                ...
                html += '<tr class="TRow" data="' + item.CustomerTypeID + '">';
                ...
                html += '<td>' + item.CustomerTypeCode + '</td>';
...
function LoadEvent() {
    ...
    $('.btnSave').on('click', function (event) {
      ...
      //  alert($("input[name=chkStatus]:checked").val())
        formData.append("CustomerTypeID", ID);
            ...
            buttons: {
                tryAgain: {
                    ...
                    action: function () {
                        ...
                        formData.append("CustomerTypeID", $item.attr('data'));
