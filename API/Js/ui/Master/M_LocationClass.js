...
function SetControl(item) {
    ...
    ID = item.LocationClassID;

    
   
    $(".txtLocationClassCode").val(item.LocationClassCode);
...
function Search() {
    ...
    formData.append("LocationClassCode", $(".txtLocationClassCodeSearch").val());
    formData.append("Name", $(".txtLocationClassNameSearch").val());
    ...
    $.ajax({
        ...
        success: function (result) {
            ...
            $.each(obj, function (key, item) {
                ...
                html += '<tr class="TRow" data="' + item.LocationClassID + '">';
                ...
                html += '<td>' + item.LocationClassCode + '</td>';
...
function LoadEvent() {
    ...
    $('.btnSave').on('click', function (event) {
      ...
      //  alert($("input[name=chkStatus]:checked").val())
        formData.append("LocationClassID", ID);
            ...
            buttons: {
                tryAgain: {
                    ...
                    action: function () {
                        ...
                        formData.append("LocationClassID", $item.attr('data'));
