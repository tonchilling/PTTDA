...
function SetControl(item) {
    ...
    $(".txtDiameterCode").val(item.DiameterCode);
...
function Search() {
    ...
    formData.append("DiameterCode", $(".txtDiameterCodeSearch").val());
    formData.append("Name", $(".txtDiameterNameSearch").val());
    ...
    $.ajax({
        ...
        success: function (result) {
            ...
            $.each(obj, function (key, item) {
                ...
                html += '<tr class="TRow" data="' + item.DiameterID + '">';
            ...
            buttons: {
                tryAgain: {
                    ...
                    action: function () {
                        ...
                        formData.append("DiameterID", $item.attr('data'));
