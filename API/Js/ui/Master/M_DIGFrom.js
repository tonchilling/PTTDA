...
function SetControl(item) {
    ...
    $(".txtDIGFromCode").val(item.DIGFromCode);
...
function Search() {
    ...
    formData.append("DIGFromCode", $(".txtDIGFromCodeSearch").val());
    ...
    $.ajax({
        ...
        success: function (result) {
            ...
            $.each(obj, function (key, item) {
                ...
                html += '<tr class="TRow" data="' + item.DIGFromID + '">';
            ...
            buttons: {
                tryAgain: {
                    ...
                    action: function () {
                        ...
                        formData.append("DIGFromID", $item.attr('data'));
