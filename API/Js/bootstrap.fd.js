...
$.FileDialog = function FileDialog(userOptions) {
    var options = $.extend($.FileDialog.defaults, userOptions),
        modal = $([
            ...
            "               <input class=\"form-control\" style=\"cursor: pointer;\" type=\"file\"  class=\"inputfile\"  placeholder=\"Choose a file...\">",
...
$.FileDialog.defaults = {
    ...
    "multiple": true,
    "ok_button": "OK",
    "readAs": "ArrayBuffer", /* possible choices: BinaryString, Text, DataURL, ArrayBuffer, */
