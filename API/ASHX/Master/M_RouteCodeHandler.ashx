<%@ WebHandler Language="C#" Class="M_RouteCodeHandler" %>
...
public class M_RouteCodeHandler : IHttpHandler, IRequiresSessionState
{


    List<M_RouteCodeDTO> list = null;
    ...
    public bool Action(HttpContext context)
    {
        ...
        M_RouteCodeBAL bal = new M_RouteCodeBAL();
    ...
    /// </summary>
    /// <returns></returns>
    public List<M_RouteCodeDTO> FindByCondition()
    {
        bool result = false;
