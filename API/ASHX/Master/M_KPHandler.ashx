<%@ WebHandler Language="C#" Class="M_KPHandler" %>
...
public class M_KPHandler : IHttpHandler, IRequiresSessionState
{


    List<M_KPDTO> list = null;
    ...
    /// </summary>
    /// <returns></returns>
    public List<M_KPDTO> FindByCondition()
    {
        bool result = false;
