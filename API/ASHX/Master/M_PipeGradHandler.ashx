<%@ WebHandler Language="C#" Class="M_PipeGradHandler" %>
...
public class M_PipeGradHandler : IHttpHandler, IRequiresSessionState
{


    List<M_PipeGradDTO> list = null;
    ...
    public bool Action(HttpContext context)
    {
        ...
        M_PipeGradBAL bal = new M_PipeGradBAL();
    ...
    /// </summary>
    /// <returns></returns>
    public List<M_PipeGradDTO> FindByCondition()
    {
        bool result = false;
