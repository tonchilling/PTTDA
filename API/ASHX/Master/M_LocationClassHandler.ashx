<%@ WebHandler Language="C#" Class="M_LocationClassHandler" %>
...
public class M_LocationClassHandler : IHttpHandler, IRequiresSessionState
{


    List<M_LocationClassDTO> list = null;
    ...
    public bool Action(HttpContext context)
    {
        ...
        M_LocationClassBAL bal = new M_LocationClassBAL();
    ...
    /// </summary>
    /// <returns></returns>
    public List<M_LocationClassDTO> FindByCondition()
    {
        bool result = false;
