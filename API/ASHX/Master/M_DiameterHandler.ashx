<%@ WebHandler Language="C#" Class="M_DiameterHandler" %>
...
public class M_DiameterHandler : IHttpHandler, IRequiresSessionState
{


    List<M_DiameterDTO> list = null;
    ...
    public bool Action(HttpContext context)
    {
        ...
        M_DiameterBAL bal = new M_DiameterBAL();
    ...
    /// </summary>
    /// <returns></returns>
    public List<M_DiameterDTO> FindByCondition()
    {
        bool result = false;
