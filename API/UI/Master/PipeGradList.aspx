<%@ Page Title="" Language="C#" MasterPageFile="~/Main.master" AutoEventWireup="true" CodeFile="PipeGradList.aspx.cs" Inherits="UI_Master_PipeGradList" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">

<script src="<%= ResolveUrl("~/Js/ui/Master/M_PipeGrad.js") %>" type="text/javascript"></script>
<script language=javascript>

 var currentURL= "<%= ResolveUrl("~/ASHX/Master/M_PipeGradHandler.ashx")%>"; 
 var ID="";
</script>
...
<div class="card cardbody">
 <div class="card-header"><i class="glyphicon glyphicon-globe fa-2x" style="color:green"></i> PipeGrad List </div>
     <div class="card-body">
  ...
  <span class="input-group-addon" id="Span2" style=" width:160px">Code :</span>
    <input   class="form-control txtPipeGradCodeSearch" id="txtPipeGradCodeSearch"  />
  ...
  <span class="input-group-addon" id="Span1" style=" width:160px">Name :</span>
     <input   class="form-control txtPipeGradNameSearch" id="txtPipeGradNameSearch"  />
...
<!--- Content --->
  ...
  <div class="modal-dialog" role="document">
   <div class="modal-content">
      ...
      <div class="modal-header header-blue">
        <h5 class="modal-title" id="exampleModalLabel"> <i class="glyphicon glyphicon-globe  fa-2x " style="color:#1363a7"></i> PipeGrad</h5>
  ...
  <span class="input-group-addon" id="Span3">Code :</span>
    <input   class="form-control txtPipeGradCode" type='text' id="txtPipeGradCode"  />
  ...
  <span class="input-group-addon" id="Span4" >Name :</span>
     <input   class="form-control txtName" type='text' id="txtName"  />
           ...
           <div  class="col-sm-1"></div>
            <div class="col-sm-10">
           <div class="input-group">
  <span class="input-group-addon" id="Span6" >Grad :</span>
     <input   class="form-control txtGradNumber" type='text' id="txtGradNumber"  />
