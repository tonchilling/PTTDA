<%@ Page Title="" Language="C#" MasterPageFile="~/Main.master" AutoEventWireup="true" CodeFile="PipelineLengthList.aspx.cs" Inherits="UI_Master_PipelineLengthList" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">

<script src="<%= ResolveUrl("~/Js/ui/Master/M_PipelineLength.js") %>" type="text/javascript"></script>
<script language=javascript>

 var currentURL= "<%= ResolveUrl("~/ASHX/Master/M_PipelineLengthHandler.ashx")%>"; 
 var ID="";
</script>
...
<div class="card cardbody">
 <div class="card-header"><i class="fa fa-cog fa-spin fa-2x" ></i> PipelineLength List </div>
     <div class="card-body">
  ...
  <span class="input-group-addon" id="Span2" style=" width:160px">Code :</span>
    <input   class="form-control txtPipelineLengthCodeSearch" id="txtPipelineLengthCodeSearch"  />
  ...
  <span class="input-group-addon" id="Span1" style=" width:160px">Name :</span>
     <input   class="form-control txtPipelineLengthNameSearch" id="txtPipelineLengthNameSearch"  />
    ...
    <div class="card ">
           ...
           <div class="row">
    <div class="col-sm-10">
          <i class="fa fa-file " ></i> PipelineLength 
          </div>
          <div class="col-sm-1">
...
<!--- Content --->
  ...
  <div class="modal-dialog" role="document">
   <div class="modal-content">
      ...
      <div class="modal-header header-blue">
        <h5 class="modal-title" id="exampleModalLabel"> <i class="fa fa-cog   fa-spin fa-2x"  ></i> Pipeline Length</h5>
  ...
  <span class="input-group-addon" id="Span3">Code :</span>
    <input   class="form-control txtPipelineLengthCode" type='text' id="txtPipelineLengthCode"  />
