<%@ Page Title="" Language="C#" MasterPageFile="~/Main.master" AutoEventWireup="true" CodeFile="InspectionData_bk.aspx.cs" Inherits="UI_Plan_InspectionData_bk" %>
...
window.onload = function () {
 ...
 //  LoadTable();
  ...
  'nested': [{
    ...
    'BVStation': '3" COTCO',
    'Mar3': '<a title="" class="linkTootrip" style="color: black;" href="/PipingInspection_test/Inspection/FullSoilToAir/2622" data-original-title=\'<div>Full soil to air inspection</div><br> <div>RC40112</div><br><div>3" COTCO</div><br><div>ปท.3 ปอก.</div><br><div>Inspection Date: 20/03/2018</div><br>\' data-toggle="tooltip" data-placement="top">FA</a>',
  }]
}, {
   'region': 'Region 2',
 'nested': [{
    ...
    'BVStation': 'RA4',
    'RouteCode':'RC4100',
    'Jan1': '<span title="" class="linkTootrip" style="color:#ffffff;background-color:red; width:100%;height:100%;display:block;overflow:auto" href="/PipingInspection_test/Inspection/FullSoilToAir/2622" data-original-title=\'<div>Full soil to air inspection</div><br> <div>RC40112</div><br><div>3" COTCO</div><br><div>ปท.3 ปอก.</div><br><div>Inspection Date: 20/03/2018</div><br>\' data-toggle="tooltip" data-placement="top">CT</span>',
  }]
}, {
  'region': 'Region 3',
  'nested': [{
...
var $table = $('#table');
  ...
  $table.bootstrapTable({
    ...
    onExpandRow: function(index, row, $detail) {
         ...
         var tableDetail='<table class="table table-bordered  tbDetail">';
 tableDetail+='<thead> <tr class="bg-primary">';
                                tableDetail+='<th data-field="No"   rowspan="2">No.</th>';
                                tableDetail+='<th data-field="LastUpdate" rowspan="2">Last Update</th>';
                                tableDetail+='<th  data-field="BVStation"   rowspan="2">BV Station</th>';
                                
                                 tableDetail+='<th  data-field="RouteCode"  rowspan="2">Route Code</th>';
                                tableDetail+='<th  rowspan="2">View</th>';
                                   tableDetail+=' <th width="160" colspan="4">ม.ค.</th>';
                                    tableDetail+='<th width="160" colspan="4">ก.พ.</th>';
                                   tableDetail+=' <th width="160" colspan="4">มี.ค.</th>';
                                   tableDetail+=' <th width="160" colspan="4">เม.ย.</th>';
                                    tableDetail+='<th width="160" colspan="4">พ.ค.</th>';
                                   tableDetail+=' <th width="160" colspan="4">มิ.ย.</th>';
                                    tableDetail+='<th width="160" colspan="4">ก.ค.</th>';
                                    tableDetail+='<th width="160" colspan="4">ส.ค.</th>';
                                    tableDetail+='<th width="160" colspan="4">ก.ย.</th>';
                                   tableDetail+=' <th width="160" colspan="4">ต.ค.</th>';
                                    tableDetail+='<th width="160" colspan="4">พ.ย.</th>';
                                   tableDetail+=' <th width="160" colspan="4">ธ.ค.</th>';
                                    tableDetail+='</tr>';
                                  tableDetail+='<tr class="bg-primary">';
                                   tableDetail+='<th  data-field="Jan1"  width="40">1</th>';
                                    tableDetail+='<th width="40">2</th>';
                                    tableDetail+='<th width="40">3</th>';
                                    tableDetail+='<th width="40">4</th>';
                                   tableDetail+='<th width="40">1</th>';
                                    tableDetail+='<th width="40">2</th>';
                                    tableDetail+='<th width="40">3</th>';
                                   tableDetail+='<th width="40">4</th>';
                                   tableDetail+='<th width="40">1</th>';
                                    tableDetail+='<th width="40">2</th>';
                                   tableDetail+='<th data-field="Mar3" width="40">3</th>';
                                    tableDetail+='<th width="40">4</th>';
                                   tableDetail+='<th width="40">1</th>';
                                    tableDetail+='<th width="40">2</th>';
                                    tableDetail+='<th width="40">3</th>';
      ...
      $detail.html(tableDetail).find('table').bootstrapTable({
     ...
     // $detail.html(tableDetail).find('table').bootstrapTable('hideLoading');
       $('.linkTootrip').tooltip({ html: true });
    }
...
$('#table').on('show.bs.collapse', function () {
    $('.collapse.in').collapse('hide');
});


      
      $("#table thead tr").addClass('bg-primary');
        $("#table tbody tr").addClass('bg-success');
        ...
        <div class="col-xs-8">
          ...
          <div class="row">
               ...
               <!-- <div class="row">
                ...
                <table class="table table-bordered table-responsive" style="background: rgb(255, 255, 255); width:100%;  margin-bottom: 0px;border-collapse:collapse;">
            ...
            <thead>
             ...
             <tr  class=" first-row "  >
                                                    ...
                                                    <td  class="text-center" style="padding: 8px 0px; text-align: center;" rowspan="3">
                                                        <a href="/PipingInspection_test/InspectionPlan/EditPlan/1050">View</a>
                                                    </td>
                                                  ...
                                                  <tr class="hiddenRow ">
                                                        ...
                                                        <td class="month-td text-center" style="background-color: rgb(255, 255, 255);">
                                                                <a title="" style="color: black;" href="/PipingInspection_test/Inspection/FullCorrosionUnderInsulation/2623" data-original-title='    <div>Full corrosion under insulation inspection</div>&#10;    <div>RC40112</div>&#10;    <div>3" COTCO</div>&#10;    <div>ปท.3 ปอก.</div>&#10;    <div>Inspection Date: 20/03/2018</div>&#10;' data-toggle="tooltip" data-placement="top">
                                                                    FCUI
                                                                </a>
                                                        </td>
                                                        <td class="month-td text-center">
                                                ...
                                                <tr class="hiddenRow ">
                                                        ...
                                                        <td class="month-td text-center" style="background-color: rgb(255, 255, 255);">
                                                                <a title="" style="color: black;" href="/PipingInspection_test/Inspection/FullCorrosionUnderPipeSupport/2624" data-original-title='    <div>Full corrosion under pipe support inspection</div>&#10;    <div>RC40112</div>&#10;    <div>3" COTCO</div>&#10;    <div>ปท.3 ปอก.</div>&#10;    <div>Inspection Date: 20/03/2018</div>&#10;' data-toggle="tooltip" data-placement="top">
                                                                    FCUS
                                                                </a>
                                                        </td>
                                                        <td class="month-td text-center">
                                               ...
                                               <tr  class="first-row  " >
                                                ...
                                                <tr class=" ">
                                                        ...
                                                        <td class="month-td text-center">
                                                                <a title="" style="color: black;" href="/PipingInspection_test/Inspection/WallThickness/2680" data-original-title="<div>Wall thickness inspecton</div><div>Wall thickness inspecton</div><div>Wall thickness inspecton</div>" data-toggle="tooltip" data-placement="top">
                                                                    WT
                                                                </a>
                                                        </td>
                                                        <td class="month-td text-center">
                                                ...
                                                <tr class=" ">
                                                        ...
                                                        <td class="month-td text-center" style="background-color: rgb(255, 255, 255);">
                                                                <a title="" style="color: black;" href="/PipingInspection_test/Inspection/SoilToAir/2681" data-original-title="    <div>Soil to air inspection</div>&#10;    <div>RC0460</div>&#10;    <div>BV2.2</div>&#10;    <div>ปท.3 ปอก.</div>&#10;    <div>Inspection Date: 20/02/2018</div>&#10;" data-toggle="tooltip" data-placement="top">
                                                                    SA
                                                                </a>
                                                        </td>
                                                        <td class="month-td text-center">
            ...
            <thead>
                      ...
                      <tr class="first-row">
                                                    ...
                                                    <td width="60" class="text-center" style="padding: 8px 0px; text-align: center;" rowspan="6">
                                                        <a href="/PipingInspection_test/InspectionPlan/EditPlan/1100">View</a>
                                                    </td>

                                                        <td class="month-td text-center" style="background-color: rgb(255, 0, 0);">
                                                                <a title="" style="color: black;" href="/PipingInspection_test/Inspection/CoatingCondition/2592" data-original-title="    <div>Coating condition inspection</div>&#10;    <div>RC4100</div>&#10;    <div>RA4</div>&#10;    <div>ปท.5 ปตก.</div>&#10;    <div>Inspection Date: 01/01/2018</div>&#10;" data-toggle="tooltip" data-placement="top">
                                                                    CT
                                                                </a>
                                                        </td>
                                                        <td class="month-td text-center">
