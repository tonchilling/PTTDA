<%@ Page Title="" Language="C#" MasterPageFile="~/Main.master" AutoEventWireup="true" CodeFile="UserRoleList.aspx.cs" Inherits="UI_Admin_UserRoleList" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">

<script src="<%= ResolveUrl("~/Js/ui/Admin/UserRole.js") %>" type="text/javascript"></script>
<script language=javascript>

 var currentURL= "<%= ResolveUrl("~/ASHX/Admin/UserRoleHandler.ashx")%>"; 
 var ID="";
</script>
 ...
 <div class="card-header"><i class="glyphicon glyphicon-globe fa-2x" style="color:green"></i> UserRole List </div>
  ...
  <span class="input-group-addon" id="Span1" style=" width:160px">Name :</span>
     <input   class="form-control txtNameSearch" id="txtNameSearch"  />
            ...
            <div class="col-sm-4">
           <div class="input-group">
  <span class="input-group-addon" id="Span2" style=" width:160px">Desc :</span>
    <input   class="form-control txtDescSearch" id="txtDescSearch"  />
...
<!--- Content --->
  ...
  <span class="input-group-addon" id="Span4" >Name :</span>
    ...
    <div  class="col-sm-1"></div>
            <div class="col-sm-10">
           <div class="input-group">
  <span class="input-group-addon" id="Span3">Desc :</span>
    <input   class="form-control txtDesc" type='text' id="txtDesc"  />
