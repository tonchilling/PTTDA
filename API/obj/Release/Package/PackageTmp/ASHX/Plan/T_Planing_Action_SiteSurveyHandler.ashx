<%@ WebHandler Language="C#" Class="T_Planing_Action_SiteSurveyHandler" %>
...
public class T_Planing_Action_SiteSurveyHandler : IHttpHandler, IRequiresSessionState
{


    List<T_Planing_Action_SiteSurveyDTO> list = null;
    ...
    string planPath = System.Configuration.ConfigurationManager.AppSettings["UploadPlan"] + "/Action/SiteSurvey";

    string mainPlan = System.Configuration.ConfigurationManager.AppSettings["UploadPlan"];
    ...
    public bool Action(HttpContext context)
    {
        ...
        T_Planing_Action_SiteSurveyBAL bal = new T_Planing_Action_SiteSurveyBAL();
    ...
    /// </summary>
    /// <returns></returns>
    public List<T_Planing_Action_SiteSurveyDTO> FindByCondition()
    {
        bool result = false;
    ...
    public T_Planing_Action_SiteSurveyDTO View()
    {
        bool result = false;
        List<T_Planing_Action_SiteSurveyDTO> objList = null;
        ...
        if (dto != null && dto.UploadFileList != null)
        {
            ...
            {
                uploadFile.HtmlFile = System.Web.VirtualPathUtility.ToAbsolute(planPath + "/" + uploadFile.PID + "/" + uploadFile.UploadType + "/" + uploadFile.FileName);
            }
        
        }


        if (dto != null && dto.PlanFileList != null)
        {

            foreach (var uploadFile in dto.PlanFileList)
            {
                uploadFile.HtmlFile = System.Web.VirtualPathUtility.ToAbsolute(mainPlan + "/" + uploadFile.PID + "/" + uploadFile.FileName);
            }
