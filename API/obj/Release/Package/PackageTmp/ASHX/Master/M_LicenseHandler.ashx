<%@ WebHandler Language="C#" Class="M_LicenseHandler" %>
...
using DTO.PTT.Admin;
public class M_LicenseHandler : IHttpHandler, IRequiresSessionState
{


    List<M_LicenseDTO> list = null;

    M_LicenseDTO dto = null;
    bool result = false;
    ...
    {
        bool result = false;
        dto = ConvertX.GetReqeustForm<M_LicenseDTO>();

        //  dto.PositionPSI = context.Request.Form["selectPosition"].ToString();
        M_LicenseBAL bal = new M_LicenseBAL();
    ...
    /// </summary>
    /// <returns></returns>
    public List<M_LicenseDTO> FindByCondition()
    {
        bool result = false;
