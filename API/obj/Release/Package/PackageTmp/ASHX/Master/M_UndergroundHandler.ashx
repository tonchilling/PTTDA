<%@ WebHandler Language="C#" Class="M_UndergroundHandler" %>
...
public class M_UndergroundHandler : IHttpHandler, IRequiresSessionState
{


    List<M_UndergroundDTO> list = null;

    M_UndergroundDTO dto = null;
    bool result = false;
    ...
    {
        bool result = false;
        dto = ConvertX.GetReqeustForm<M_UndergroundDTO>();

        //  dto.PositionPSI = context.Request.Form["selectPosition"].ToString();
        M_UndergroundBAL bal = new M_UndergroundBAL();
    ...
    /// </summary>
    /// <returns></returns>
    public List<M_UndergroundDTO> FindByCondition()
    {
        bool result = false;
