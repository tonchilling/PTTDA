<%@ WebHandler Language="C#" Class="M_StationHandler" %>
...
public class M_StationHandler : IHttpHandler, IRequiresSessionState
{

    List<M_StationDTO> list = null;
    ...
    public bool Action(HttpContext context)
    {
        ...
        M_StationBAL bal = new M_StationBAL();
    ...
    /// </summary>
    /// <returns></returns>
    public List<M_StationDTO> FindByCondition()
    {
        bool result = false;
