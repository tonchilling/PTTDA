<%@ Page Title="" Language="C#" MasterPageFile="~/Main.master" AutoEventWireup="true"
     ...
     CodeFile="Index.aspx.cs" Inherits="UI_Index" %>
...
$(document).ready(function () {
    ...
    LoadDropDownList($('.ddlYear1'), "M_Year", currentYear);
      LoadDropDownList($('.ddlYear'), "M_Year", currentYear);
     // LoadDropDownList($('#ddlRegion1'), "m_region");
      // LoadDropDownList($('.ddlAssetOwner'), "M_AssertOwner");
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
 ...
 <div class="content-wrapper">
  ...
  <span class="input-group-addon" id="Span2">Asset Owner :</span>
                            <select class="form-control" data-val="true" data-val-number="The field CustomerTypeID must be a number." data-val-required="The CustomerTypeID field is required." id="ddlAssertOwner1" name="ddlAssertOwner1"><option selected="selected" value="0">ทั้งหมด</option>
...
<option value="41">-</option>
                    ...
                    <div class="col-sm-4">
           <div class="input-group">
  <span class="input-group-addon" id="Span1">Type Of line: </span>
    <select class="form-control" data-val="true" data-val-number="The field TypeOfRouteCodeID must be a number." data-val-required="The TypeOfRouteCodeID field is required." id="ddlPipeline1" name="TypeOfRouteCodeID"><option selected="selected" value="0">ทั้งหมด</option>
...
<option value="45">DISTRIBUTION_LP</option>
  ...
  <span class="input-group-addon" id="Span5">Region :</span>
   <select name="RegionID" class="form-control ddlRegion" id="ddlRegion1" 
...
<option value="3">Q4</option>
           ...
           <div class="col-sm-2">
           <div class="input-group">
  <span class="input-group-addon" id="Span10">Year :</span>
   <select name="ddlYear" class="form-control ddlYear1" id="ddlYear1" data-val-required="The Quater field is required." 
   data-val-number="The field Quater must be a number." data-val="true"><option selected="selected" value="0">ทั้งหมด</option>
...
<option selected="selected" value="12">ธ.ค.</option>
            ...
            <div class="col-sm-1">
              <button type="button" class="btn btn-lg btn-primary btnSearchGraph">ค้นหา</button>
            </div>
          </div>
...
<option value="RC033010">RC033010</option>
  ...
  <span class="input-group-addon" id="Span19">Dig From</span>
       <select class="form-control ddlDIGFrom" data-val="true" data-val-number="The field ToMonth must be a number." data-val-required="The ToMonth field is required." id="ddlDIGFrom" name="ddlDIGFrom">
  ...
  <span class="input-group-addon" id="Span15">Type Of line:</span>
                            <select class="form-control ddlPipeline" data-val="true" data-val-number="The field CustomerTypeID must be a number." data-val-required="The CustomerTypeID field is required." id="ddlPipeline" name="CustomerTypeID"><option selected="selected" value="0">ทั้งหมด</option>
  ...
  <span class="input-group-addon" id="Span16">Asset Owner</span>
                            <select class="form-control ddlAssertOwner" data-val="true" 
                            data-val-number="The field Assert Owner must be a number." data-val-required="The Assert Owner field is required."
                             id="ddlAssertOwner" name="ddlAssertOwner"><option selected="selected" value="0">ทั้งหมด</option>
   ...
   <table class="easyui-datagrid table-blue"  title="">
        ...
        <thead data-options="frozen:true">
                ...
                <tr>
                    ...
                    <th data-options="field:'StartEndPipeline',width:150,align:'center'">Section</th>
						...
						<li class="timeline-item ">
							...
							<div class="timeline-panel  alert alert-warning back-widget-set xzoom" style="height:220px;">
								...
								<div class="timeline-body">
									<div class="text-left divtxtNote"> 1.TBC=to be confirmed<br>
          ...
          <td>Shift to next year</td>
						...
						<li class="timeline-item">
							...
							<div class="timeline-panel alert alert-danger xzoom" style="height:220px;">
								...
								<div class="timeline-body">
									 <div class="text-left divReference">
  ...
  <li class="connect" ><label><input type="checkbox" class="chkPO chkPO10"/> PR:10%</label>
    <ul class="accounts">
      <li ><label>กระบวนการจัดหา</label><label class="lbPO60 invisible" style="color:Red;">(* กรุณาเลือกกระบวนการจัดหา)</label>
  ...
  <span class="input-group-addon" id="Span7" >% Complete:</span>
     <input   class="form-control txtComplete require " type='text' id="txtComplete" placeholder="กรุณาระบุ % ความคืบหน้าของ Spec"  />
...
<br />
<div class="input-group date"  data-provide="datepicker">
<span class="input-group-addon" id="Span8" >Event Date </span>
 ...
 <span class="lblError" style="color:red"></span>
  ...
  <span class="input-group-addon" id="Span9" >PO Number :</span>
     ...
     -->
      <script src="<%= ResolveUrl("~/Js/chartNew/Chart.Canvas.js") %>"></script>
       <script src="<%= ResolveUrl("~/Js/ui/Index.js") %>"></script>
          ...
          <script src="<%= ResolveUrl("~/Js/ui/Plan/T_PlanList.js?ver=2.1") %>" type="text/javascript"></script>
