...
<option value="2020">2022</option>
  ...
  <span class="input-group-addon" id="Span16">Asset Owner</span>
                            <select class="form-control ddlAssertOwner" data-val="true" data-val-number="The field Assert Owner must be a number." data-val-required="The Asset Owner field is required." id="ddlAssertOwner" name="ddlAssertOwner"><option selected="selected" value="0">ทั้งหมด</option>
       ...
       <div class="row" style="padding-top:10px;">
         ...
         <table class="easyui-datagrid table-blue table-responsive"   id="datagrid"  title="">
     ...
     <thead>
          ...
          2.ข้อมูลกาารแบ่งประเภท Asset นำมาจากหน่วยงาน</div>
								</div>
							</div>
