<%@ Page Title="" Language="C#" MasterPageFile="~/Main.master" AutoEventWireup="true" CodeFile="RegionList.aspx.cs" Inherits="UI_Master_RegionList" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">

<script src="<%= ResolveUrl("~/Js/ui/Master/M_Region.js") %>" type="text/javascript"></script>
<script language=javascript>

 var currentURL= "<%= ResolveUrl("~/ASHX/Master/M_RegionHandler.ashx")%>"; 
 var ID="";
</script>
...
<div class="card cardbody">
 <div class="card-header"><i class="fa fa-cog fa-spin fa-2x" ></i>  Region List </div>
     <div class="card-body">
  ...
  <span class="input-group-addon" id="Span2" style=" width:160px">Code :</span>
    <input   class="form-control txtRegionCodeSearch" id="txtRegionCodeSearch"  />
  ...
  <span class="input-group-addon" id="Span1" style=" width:160px">Name :</span>
     <input   class="form-control txtRegionNameSearch" id="txtRegionNameSearch"  />
...
<!--- Content --->
  ...
  <div class="modal-dialog" role="document">
   <div class="modal-content">
      ...
      <div class="modal-header header-blue">
        <h5 class="modal-title" id="exampleModalLabel"> <i class="fa fa-cog fa-spin fa-2x" ></i>  Region</h5>
  ...
  <span class="input-group-addon" id="Span3">Code :</span>
    <input   class="form-control txtRegionCode" type='text' id="txtRegionCode"  />
