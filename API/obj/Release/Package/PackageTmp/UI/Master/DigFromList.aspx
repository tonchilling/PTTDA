<%@ Page Title="" Language="C#" MasterPageFile="~/Main.master" AutoEventWireup="true" CodeFile="DigFromList.aspx.cs" Inherits="UI_Master_DigFromList" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">

<script src="<%= ResolveUrl("~/Js/ui/Master/M_DIGFrom.js") %>" type="text/javascript"></script>
<script language=javascript>

 var currentURL= "<%= ResolveUrl("~/ASHX/Master/M_DIGFromHandler.ashx")%>"; 
 var ID="";
</script>
...
<div class="card cardbody">
 <div class="card-header"><i class="fa fa-cog fa-spin fa-2x" ></i>  Dig From List </div>
     <div class="card-body">
  ...
  <span class="input-group-addon" id="Span2" style=" width:160px">Code :</span>
    <input   class="form-control txtDIGFromCodeSearch" id="txtDIGFromCodeSearch"  />
...
<!--- Content --->
  ...
  <div class="modal-dialog" role="document">
   <div class="modal-content">
      ...
      <div class="modal-header header-blue">
        <h5 class="modal-title" id="exampleModalLabel"> <i class="fa fa-cog fa-spin fa-2x" ></i> Dig From</h5>
  ...
  <span class="input-group-addon" id="Span3">Code :</span>
    <input   class="form-control txtDIGFromCode" type='text' id="txtDIGFromCode"  />
