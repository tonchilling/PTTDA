<%@ Page Title="" Language="C#" MasterPageFile="~/Main.master" AutoEventWireup="true" CodeFile="MAOPList.aspx.cs" Inherits="UI_Master_MAOPList" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">

<script src="<%= ResolveUrl("~/Js/ui/Master/M_MAOP.js") %>" type="text/javascript"></script>
<script language=javascript>

 var currentURL= "<%= ResolveUrl("~/ASHX/Master/M_MAOPHandler.ashx")%>"; 
 var ID="";
</script>
...
<div class="card cardbody">
 <div class="card-header"><i class="fa fa-cog fa-spin fa-2x" ></i>  MAOP List </div>
     <div class="card-body">
  ...
  <span class="input-group-addon" id="Span2" style=" width:160px">Code :</span>
    <input   class="form-control txtMAOPCodeSearch" id="txtMAOPCodeSearch"  />
  ...
  <span class="input-group-addon" id="Span1" style=" width:160px">Name :</span>
     <input   class="form-control txtMAOPNameSearch" id="txtMAOPNameSearch"  />
...
<!--- Content --->
  ...
  <div class="modal-dialog" role="document">
   <div class="modal-content">
      ...
      <div class="modal-header header-blue">
        <h5 class="modal-title" id="exampleModalLabel"> <i class="fa fa-cog fa-spin fa-2x" ></i> MAOP</h5>
  ...
  <span class="input-group-addon" id="Span3">Code :</span>
    <input   class="form-control txtMAOPCode" type='text' id="txtMAOPCode"  />
