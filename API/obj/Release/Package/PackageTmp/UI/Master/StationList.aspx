<%@ Page Title="" Language="C#" MasterPageFile="~/Main.master" AutoEventWireup="true" CodeFile="StationList.aspx.cs" Inherits="UI_Master_StationList" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">

<script src="<%= ResolveUrl("~/Js/ui/Master/M_Station.js") %>" type="text/javascript"></script>
<script language=javascript>

 var currentURL= "<%= ResolveUrl("~/ASHX/Master/M_StationHandler.ashx")%>"; 
 var ID="";
</script>
...
<div class="card cardbody">
 <div class="card-header"><i class="fa fa-cog fa-spin fa-2x" ></i> Station List </div>
     <div class="card-body">
  ...
  <span class="input-group-addon" id="Span2" style=" width:160px">Code :</span>
    <input   class="form-control txtStationCodeSearch" id="txtStationCodeSearch"  />
  ...
  <span class="input-group-addon" id="Span1" style=" width:160px">Name :</span>
     <input   class="form-control txtStationNameSearch" id="txtStationNameSearch"  />
...
<!--- Content --->
  ...
  <div class="modal-dialog" role="document">
   <div class="modal-content">
      ...
      <div class="modal-header header-blue">
        <h5 class="modal-title" id="exampleModalLabel"> <i class="fa fa-cog fa-spin fa-2x" ></i> Station</h5>
  ...
  <span class="input-group-addon" id="Span3">Code :</span>
    <input   class="form-control txtStationCode" type='text' id="txtStationCode"  />
