<%@ Page Title="" Language="C#" MasterPageFile="~/Main.master" AutoEventWireup="true" CodeFile="CustomerTypeList.aspx.cs" Inherits="UI_Master_CustomerTypeList" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">

<script src="<%= ResolveUrl("~/Js/ui/Master/M_CustomerType.js") %>" type="text/javascript"></script>
<script language=javascript>

 var currentURL= "<%= ResolveUrl("~/ASHX/Master/M_CustomerTypeHandler.ashx")%>"; 
 var ID="";
</script>
...
<div class="card cardbody">
 <div class="card-header"><i class="glyphicon glyphicon-globe fa-2x" style="color:green"></i> CustomerType List </div>
     <div class="card-body">
  ...
  <span class="input-group-addon" id="Span2" style=" width:160px">Code :</span>
    <input   class="form-control txtCustomerTypeCodeSearch" id="txtCustomerTypeCodeSearch"  />
  ...
  <span class="input-group-addon" id="Span1" style=" width:160px">Name :</span>
     <input   class="form-control txtCustomerTypeNameSearch" id="txtCustomerTypeNameSearch"  />
    ...
    <div class="card ">
           ...
           <div class="row">
    <div class="col-sm-10">
          <i class="fa fa-file " ></i> CustomerType 
          </div>
          <div class="col-sm-1">
...
<!--- Content --->
  ...
  <div class="modal-dialog" role="document">
   <div class="modal-content">
      ...
      <div class="modal-header header-blue">
        <h5 class="modal-title" id="exampleModalLabel"> <i class="glyphicon glyphicon-globe  fa-2x " style="color:#1363a7"></i> CustomerType</h5>
  ...
  <span class="input-group-addon" id="Span3">Code :</span>
    <input   class="form-control txtCustomerTypeCode" type='text' id="txtCustomerTypeCode"  />
