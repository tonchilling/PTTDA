<%@ Page Title="" Language="C#" MasterPageFile="~/Main.master" AutoEventWireup="true" CodeFile="CoatingTypeList.aspx.cs" Inherits="UI_Master_CoatingTypeList" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">

<script src="<%= ResolveUrl("~/Js/ui/Master/M_CoatingType.js") %>" type="text/javascript"></script>
<script language=javascript>

 var currentURL= "<%= ResolveUrl("~/ASHX/Master/M_CoatingTypeHandler.ashx")%>"; 
 var ID="";
</script>
...
<div class="card cardbody">
 <div class="card-header"><i class="fa fa-cog fa-spin fa-2x" ></i> CoatingType List </div>
     <div class="card-body">
  ...
  <span class="input-group-addon" id="Span2" style=" width:160px">Code :</span>
    <input   class="form-control txtCoatingTypeCodeSearch" id="txtCoatingTypeCodeSearch"  />
  ...
  <span class="input-group-addon" id="Span1" style=" width:160px">Name :</span>
     <input   class="form-control txtCoatingTypeNameSearch" id="txtCoatingTypeNameSearch"  />
  ...
  <div class="row" style="padding-top:30px;">
    ...
    <div class="card ">
           ...
           <div class="row">
    <div class="col-sm-10">
          <i class="fa fa-file " ></i> CoatingType 
          </div>
          <div class="col-sm-1">
...
<!--- Content --->
  ...
  <div class="modal-dialog" role="document">
   <div class="modal-content">
      ...
      <div class="modal-header header-blue">
        <h5 class="modal-title" id="exampleModalLabel"><i class="fa fa-cog fa-spin fa-2x" ></i> Coating Type</h5>
  ...
  <span class="input-group-addon" id="Span3">Code :</span>
    <input   class="form-control txtCoatingTypeCode" type='text' id="txtCoatingTypeCode"  />
