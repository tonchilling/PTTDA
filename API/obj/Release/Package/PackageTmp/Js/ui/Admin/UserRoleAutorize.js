...
$(document).ready(function () {
    ...
    var $li = $('.divfordtreeview .expanded li').click(function () {
        ...
        $('.txtMenu').val($(this).find('span').text());
    ...
    $('.btnSave').click(function () {
        ...
        $("tr.TRow").each(function () {
            ...
            this_tag = new Object();
            this_tag.USERRoleID = $(this).attr("USERRoleID");
            this_tag.MENU_OID = menuID;
            this_tag.USERRole_Autorize_OID = $(this).attr("USERRole_Autorize_OID");
    ...
    $.ajax({
        ...
        success: function (result) {
            ...
            $.each(itemGroup, function (key, objItem) {
                ...
                if (item != null) {
                    ...
                    $.each(item, function (key, objItem) {
                        ...
                        html += '<li class="searchterm"  onclick="MenuEvent(event,this)"><i class="glyphicon glyphicon-globe linksub"></i> <span data="' + objItem.MENU_OID + '">' + objItem.Name + '</span></li>';
            ...
            html += '<span class="hasSub"><i class="glyphicon glyphicon-folder-close folder"></i> Top Menu</span>';
             itemGroup = obj.filter(function (tempItemGroup) {
...
function Search() {
    ...
    var txtMenu = $('.txtMenu').val() != null ? $('.txtMenu').val() : "";
    ...
    if (menuID == '') {
        formData.append("USERRoleID", 'none');
     }
    ...
    $.ajax({
        ...
        success: function (result) {
            ...
            $.each(obj, function (key, item) {
              ...
              //  alert(item.VIEW)
                html += '<tr class="TRow" USERRoleID="' + item.USERRoleID + '" USERRole_Autorize_OID="' + item.USERRole_Autorize_OID + '">';
