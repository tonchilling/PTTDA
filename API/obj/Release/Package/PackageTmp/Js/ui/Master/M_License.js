...
function SetControl(item) {
    ...
    $(".txtLicenseCode").val(item.LicenseCode);
...
function Search() {
    ...
    formData.append("LicenseCode", $(".txtLicenseCodeSearch").val());
    formData.append("Name", $(".txtLicenseNameSearch").val());
    ...
    $.ajax({
        ...
        success: function (result) {
            ...
            $.each(obj, function (key, item) {
                ...
                html += '<tr class="TRow" data="' + item.LicenseID + '">';
            ...
            buttons: {
                tryAgain: {
                    ...
                    action: function () {
                        ...
                        formData.append("LicenseID", $item.attr('data'));
