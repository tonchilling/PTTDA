...
function SetControl(item) {
    ...
    ID = item.CoatingTypeID;

    
   
    $(".txtCoatingTypeCode").val(item.CoatingTypeCode);
...
function Search() {
    ...
    formData.append("CoatingTypeCode", $(".txtCoatingTypeCodeSearch").val());
    formData.append("Name", $(".txtCoatingTypeNameSearch").val());
    ...
    $.ajax({
        ...
        success: function (result) {
            ...
            $.each(obj, function (key, item) {
                ...
                html += '<tr class="TRow" data="' + item.CoatingTypeID + '">';
                ...
                html += '<td>' + item.CoatingTypeCode + '</td>';
...
function LoadEvent() {
    ...
    $('.btnSave').on('click', function (event) {
      ...
      //  alert($("input[name=chkStatus]:checked").val())
        formData.append("CoatingTypeID", ID);
            ...
            buttons: {
                tryAgain: {
                    ...
                    action: function () {
                        ...
                        formData.append("CoatingTypeID", $item.attr('data'));
