...
function SetControl(item) {
    ...
    $(".txtRouteCode").val(item.RouteCode);
...
function Search() {
    ...
    formData.append("RouteCode", $(".txtRouteCodeSearch").val());
    formData.append("Name", $(".txtRouteCodeNameSearch").val());
    ...
    $.ajax({
        ...
        success: function (result) {
            ...
            $.each(obj, function (key, item) {
                ...
                html += '<tr class="TRow" data="' + item.RouteID + '">';
            ...
            $('.divMainTable table').on('order.dt', function () { console.log('Order'); })
        .on('search.dt', function () { console.log('Search'); })
        .on('page.dt', function () { }).DataTable({
...
function LoadEvent() {
    ...
    $('.divMainTable table').on('page.dt', function () {
       alert('22')
    });
            ...
            buttons: {
                tryAgain: {
                    ...
                    action: function () {
                        ...
                        formData.append("RouteID", $item.attr('data'));
