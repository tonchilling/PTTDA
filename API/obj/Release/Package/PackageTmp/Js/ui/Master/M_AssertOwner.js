...
function SetControl(item) {
    ...
    ID = item.AssertOwnerID;

    
   
    $(".txtAssertOwnerCode").val(item.AssertOwnerCode);
    ...
    $.ajax({
        ...
        success: function (result) {
            ...
            $.each(obj, function (key, item) {
                ...
                html += '<tr class="TRow" data="' + item.AssertOwnerID + '">';
                ...
                html += '<td>' + item.AssertOwnerCode + '</td>';
...
function LoadEvent() {
    ...
    $('.btnSave').on('click', function (event) {
      ...
      //  alert($("input[name=chkStatus]:checked").val())
        formData.append("AssertOwnerID", ID);
            ...
            buttons: {
                tryAgain: {
                    ...
                    action: function () {
                        ...
                        formData.append("AssertOwnerID", $item.attr('data'));
