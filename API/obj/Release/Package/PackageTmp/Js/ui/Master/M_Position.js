...
function SetControl(item) {
    ...
    $(".txtNameEng").val(item.NameEng);
    $(".txtRole").val(item.Role);
...
function Search() {
    ...
    formData.append("NameEng", $(".txtNameEngSearch").val());
    ...
    $.ajax({
        ...
        success: function (result) {
            ...
            $.each(obj, function (key, item) {
                ...
                html += '<tr class="TRow" data="' + item.PositionID + '">';
            ...
            buttons: {
                tryAgain: {
                    ...
                    action: function () {
                        ...
                        formData.append("PositionID", $item.attr('data'));
