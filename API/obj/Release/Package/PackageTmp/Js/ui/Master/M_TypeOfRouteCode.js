...
function SetControl(item) {
    ...
    ID = item.TypeOfRouteID;

    
   
    $(".txtTypeOfRouteCode").val(item.TypeOfRouteCode);
...
function Search() {
    ...
    formData.append("TypeOfRouteCode", $(".txtTypeOfRouteCodeSearch").val());
    formData.append("Name", $(".txtTypeOfRouteCodeNameSearch").val());
    ...
    $.ajax({
        ...
        success: function (result) {
            ...
            $.each(obj, function (key, item) {
                ...
                html += '<tr class="TRow" data="' + item.TypeOfRouteID + '">';
                ...
                html += '<td>' + item.TypeOfRouteCode + '</td>';
...
function LoadEvent() {
    ...
    $('.btnSave').on('click', function (event) {
      ...
      //  alert($("input[name=chkStatus]:checked").val())
        formData.append("TypeOfRouteID", ID);
            ...
            buttons: {
                tryAgain: {
                    ...
                    action: function () {
                        ...
                        formData.append("TypeOfRouteID", $item.attr('data'));
