...
function SetControl(item) {
    ...
    $(".txtRegionCode").val(item.RegionCode);
...
function Search() {
    ...
    formData.append("RegionCode", $(".txtRegionCodeSearch").val());
    formData.append("Name", $(".txtRegionNameSearch").val());
    ...
    $.ajax({
        ...
        success: function (result) {
            ...
            $.each(obj, function (key, item) {
                ...
                html += '<tr class="TRow" data="' + item.RegionID + '">';
            ...
            buttons: {
                tryAgain: {
                    ...
                    action: function () {
                        ...
                        formData.append("RegionID", $item.attr('data'));
