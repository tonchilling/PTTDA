...
function SetControl(item) {
    ...
    ID = item.PipelineLengthID;

    
   
    $(".txtPipelineLengthCode").val(item.PipelineLengthCode);
...
function Search() {
    ...
    formData.append("PipelineLengthCode", $(".txtPipelineLengthCodeSearch").val());
    formData.append("Name", $(".txtPipelineLengthNameSearch").val());
    ...
    $.ajax({
        ...
        success: function (result) {
            ...
            $.each(obj, function (key, item) {
                ...
                html += '<tr class="TRow" data="' + item.PipelineLengthID + '">';
                ...
                html += '<td>' + item.PipelineLengthCode + '</td>';
...
function LoadEvent() {
    ...
    $('.btnSave').on('click', function (event) {
      ...
      //  alert($("input[name=chkStatus]:checked").val())
        formData.append("PipelineLengthID", ID);
            ...
            buttons: {
                tryAgain: {
                    ...
                    action: function () {
                        ...
                        formData.append("PipelineLengthID", $item.attr('data'));
